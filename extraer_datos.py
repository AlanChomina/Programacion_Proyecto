...
def tics_hogar():
    ...
    df.to_csv("indicadores_tics_inegi.csv", index=False)
...
def educacion():
    ...
    df = pd.DataFrame(registros)
    df.to_csv("indicadores_educacion_inegi.csv", index=False)
...
def empleo():
    ...
    df = pd.DataFrame(registros)
    df.to_csv("indicadores_empleo_inegi.csv", index=False)
...
def vivienda():
    ...
    df = pd.DataFrame(registros)
    df.to_csv("indicadores_vivienda_inegi.csv", index=False)
...
def poblacion():
    ...
    df = pd.DataFrame(registros)
    df.to_csv("indicadores_poblacion_inegi.csv", index=False)
